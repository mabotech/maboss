    ...
    '$scope', '$injector', function($scope, $injector) {
      ...
      $scope.setupScope = function(formObject) {
        ...
        $scope.$watch('[name, readonly, label, description, placeholder, required, options, validation]', function() { //mabo
          ...
          formObject.readonly = $scope.readonly; //mabo
    ...
    '$scope', '$injector', function($scope, $injector) {
      ...
      return $scope.updateInput = function(value) {
        ...
        input = {
          ...
          name:$scope.formObject.name, // add by mabo
...
(function() {
  ...
  angular.module('builder.provider', []).provider('$builder', function() {
    ...
    this.convertFormObject = function(name, formObject) {
      ...
      //console.log(JSON.stringify(formObject));//mabo
      result = {
        id: (_ref1 = formObject.id) != null ? _ref1 : this.formsId[name]++,
        name: formObject.name, // mabo
        readonly:formObject.readonly, //mabo
