define([
  ...
  module.controller('SearchCtrl', [
    ...
    'datasourceSrv',
    '$timeout',
    function ($scope, $rootScope, $element, $location, datasourceSrv, $timeout) {
      $scope.init = function () {
      ...
      $scope.searchDashboards = function (queryString) {
        ...
        return $scope.db.searchDashboards(queryString).then(function (results) {
      ...
      $scope.deleteDashboard = function (dash, evt) {
        evt.stopPropagation();
        $scope.appEvent('delete-dashboard', {
          id: dash.id,
          title: dash.title
        });
      };
