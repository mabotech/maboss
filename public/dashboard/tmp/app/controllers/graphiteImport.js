define([
  ...
  module.controller('GraphiteImportCtrl', [
    '$scope',
    '$rootScope',
    '$timeout',
    'datasourceSrv',
    '$location',
    function ($scope, $rootScope, $timeout, datasourceSrv, $location) {
      $scope.init = function () {
      ...
      $scope.listAll = function (query) {
        delete $scope.error;
        $scope.datasource.listDashboards(query).then(function (results) {
