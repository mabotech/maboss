define([
  ...
  module.config([
    ...
    function ($routeProvider) {
      $routeProvider.when('/dashboard/script/:jsFile', {
  ...
  module.controller('DashFromScriptProvider', [
    ...
    'datasourceSrv',
    '$timeout',
    function ($scope, $rootScope, $http, $routeParams, $q, dashboardSrv, datasourceSrv, $timeout) {
      ...
      var script_load = function (file) {
        ...
        return $http({
          url: url,
          method: 'GET'
        }).then(execute_script).then(null, function (err) {
