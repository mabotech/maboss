define([
  ...
  'use strict';
  angular.module('grafana.directives').directive('dropdownTypeahead', [
    '$compile',
    function ($compile) {
      ...
      var buttonTemplate = '<a  class="grafana-target-segment grafana-target-function dropdown-toggle"' + ' tabindex="1" gf-dropdown="menuItems" data-toggle="dropdown"' + ' data-placement="top"><i class="icon-plus"></i></a>';
      return {
        scope: {
