define([
  ...
  module.factory('OpenTSDBDatasource', [
    '$q',
    '$http',
    'templateSrv',
    function ($q, $http, templateSrv) {
      ...
      OpenTSDBDatasource.prototype.query = function (options) {
        ...
        return this.performTimeSeriesQuery(queries, start, end).then(_.bind(function (response) {
      ...
      function transformMetricData(md, groupByTags, options) {
        var dps = [], tagData = [], metricLabel = null;
      ...
      function convertTargetToQuery(target) {
        ...
        if (target.shouldComputeRate) {
          query.rate = true;
          query.rateOptions = { counter: !!target.isCounter };
