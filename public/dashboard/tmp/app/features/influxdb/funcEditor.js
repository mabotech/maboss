define([
  ...
  'use strict';
  angular.module('grafana.directives').directive('influxdbFuncEditor', [
    '$compile',
    function ($compile) {
      var funcSpanTemplate = '<a gf-dropdown="functionMenu" class="dropdown-toggle" ' + 'data-toggle="dropdown">{{target.function}}</a><span>(</span>';
