define([
  ...
  'use strict';
  angular.module('grafana.directives').directive('graphiteFuncEditor', [
    '$compile',
    'templateSrv',
    function ($compile, templateSrv) {
      var funcSpanTemplate = '<a ng-click="">{{func.def.name}}</a><span>(</span>';
      var paramTemplate = '<input type="text" style="display:none"' + ' class="input-mini grafana-function-param-input"></input>';
      var funcControlsTemplate = '<div class="graphite-func-controls">' + '<span class="pointer icon-arrow-left"></span>' + '<span class="pointer icon-info-sign"></span>' + '<span class="pointer icon-remove" ></span>' + '<span class="pointer icon-arrow-right"></span>' + '</div>';
      return {
        restrict: 'A',
