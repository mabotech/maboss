define([
  ...
  module.controller('DashboardCtrl', [
    ...
    '$timeout',
    function ($scope, $rootScope, dashboardKeybindings, timeSrv, templateValuesSrv, dashboardSrv, dashboardViewStateSrv, $timeout) {
      $scope.editor = { index: 0 };
      $scope.panelNames = _.map(config.panels, function (value, key) {
        return key;
      });
      ...
      $scope.registerWindowResizeEvent = function () {
        angular.element(window).bind('resize', function () {
          ...
          resizeEventTimeout = $timeout(function () {
