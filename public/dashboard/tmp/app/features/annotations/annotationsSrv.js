define([
  ...
  module.service('annotationsSrv', [
    'datasourceSrv',
    '$q',
    'alertSrv',
    '$rootScope',
    '$sanitize',
    function (datasourceSrv, $q, alertSrv, $rootScope, $sanitize) {
      var promiseCached;
      var list = [];
      var timezone;
      this.init = function () {
      ...
      this.getAnnotations = function (rangeUnparsed, dashboard) {
        ...
        var promises = _.map(annotations, function (annotation) {
            ...
            return datasource.annotationQuery(annotation, rangeUnparsed).then(this.receiveAnnotationResults).then(null, errorHandler);
          }, this);
