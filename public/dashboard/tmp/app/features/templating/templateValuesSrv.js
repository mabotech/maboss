define([
  ...
  module.service('templateValuesSrv', [
    '$q',
    '$rootScope',
    'datasourceSrv',
    '$routeParams',
    'templateSrv',
    'timeSrv',
    function ($q, $rootScope, datasourceSrv, $routeParams, templateSrv, timeSrv) {
      var self = this;
      ...
      this.setVariableValue = function (variable, option, recursive) {
        ...
        return this.updateOptionsInChildVariables(variable).then(function () {
          if (!recursive) {
