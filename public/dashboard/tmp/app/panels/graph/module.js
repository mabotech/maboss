define([
  ...
  module.controller('GraphCtrl', [
    ...
    'annotationsSrv',
    'timeSrv',
    function ($scope, $rootScope, panelSrv, annotationsSrv, timeSrv) {
      ...
      $scope.get_data = function () {
        ...
        return $scope.datasource.query(metricsQuery).then($scope.dataHandler).then(null, function (err) {
      ...
      $scope.dataHandler = function (results) {
        ...
        $scope.annotationsPromise.then(function (annotations) {
          $scope.panelMeta.loading = false;
