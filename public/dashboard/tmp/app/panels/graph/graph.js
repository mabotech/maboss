define([
  ...
  module.directive('grafanaGraph', [
    '$rootScope',
    'timeSrv',
    function ($rootScope, timeSrv) {
      return {
        restrict: 'A',
        template: '<div> </div>',
        link: function (scope, elem) {
          ...
          function render_panel() {
            ...
            var options = {
                ...
                crosshair: { mode: panel.tooltip.shared || dashboard.sharedCrosshair ? 'x' : null }
              };
            for (var i = 0; i < data.length; i++) {
              var series = data[i];
          ...
          function addAxisLabels() {
            if (scope.panel.leftYAxisLabel) {
              ...
              var yaxisLabel = $('<div class=\'axisLabel yaxisLabel\'></div>').text(scope.panel.leftYAxisLabel).appendTo(elem);
