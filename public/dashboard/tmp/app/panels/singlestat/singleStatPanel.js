define([
  ...
  module.directive('singlestatPanel', [
    '$location',
    'linkSrv',
    '$timeout',
    function ($location, linkSrv, $timeout) {
      return {
        link: function (scope, elem) {
          ...
          function getBigValueHtml() {
            ...
            if (panel.prefix) {
              body += getSpan('singlestat-panel-prefix', panel.prefixFontSize, scope.panel.prefix);
            }
          ...
          elem.click(function () {
            ...
            if (linkInfo.href[0] === '#') {
              linkInfo.href = linkInfo.href.substring(1);
            }
