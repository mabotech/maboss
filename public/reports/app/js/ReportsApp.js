	...
	.controller(
		'ReportsCtrl', [
			...
			function ($scope) {
				...
				var firstNames = ["室内性能试验室", "室内性能试验室", "室内性能试验室", "环境试验室", "环境试验室", "环境试验室", "结构耐久试验室", "Ben", "Kate", "Kevin", "Thomas", "Frank"];
				var lastNames = ["整车里程耐久试验台1#", "整车里程耐久试验台2#", "整车里程耐久试验台3#", 
                        "整车高低温环境舱 \n汽车底盘测功机 \n轻型车排放分析系统 ", "常温间汽车底盘测功机\n轻型车排放分析系统 ", "四驱高温间环境舱\n汽车底盘测功机", "重型车综合性能试验台", "Bentley", "Kowalski", "Schmidt", "Tucker", "Fancy"];
				var address = ["640000-00046", "640000-00045", "640000-00093", "640000-00089\n640000-00090\n640000-00092", "640000-00094\n640000-00092", "", "640000-00096", "Germany", "Sweden", "Denmark", "Poland", "Belgium"];

                $scope.price = Math.floor(Math.random() * 100000) / 100
    ...
    $scope.dataset3[0].data.push([i, 1+Math.sin(3+i)]);
        $scope.dataset3[1].data.push([i+0.3, 1+Math.cos(3+i)]);
				...
				$scope.db.dynamicColumns = [
					...
					{data: 'address', title: '资源编号', width: 150,readOnly: true},
					{data: 'description', title: '计划工时（小时）', width: 100,readOnly: true},
					{data: 'price', title:'实报工时（小时）', type: 'numeric', width: 100, readOnly: true}
